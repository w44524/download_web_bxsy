...
def getImg(html, name, mydate):
    ...
    for imgurl in imglist:
        ...
        try:
            urllib.urlretrieve('http://www.hdbxsy.com'+imgurl,'%s_%s_%d.jpg' %(mydate, name.decode('utf-8').encode('gbk'), x))
        except:
            pass
        x+=1
        num_pic += 1
...
def getHtml_sub(html):
    ...
    for htmlurl in htmllist:
        ...
        getImg(html_sub, htmlurl[1], htmlurl[2])
        print wholeurl
        print htmlurl[1]
        print htmlurl[2]
        x+=1
